"""
=============================================================
WEEK 1 - DAY 3: DQN Agent (Pure NumPy)
=============================================================
"""
...
class DQNAgent:
    def __init__(self, state_size, action_size,
                 ...
                 buffer_capacity=20_000, batch_size=64):
        self.action_size   = action_size
        self.gamma         = gamma
        self.epsilon       = epsilon
        self.epsilon_min   = epsilon_min
        self.epsilon_decay = epsilon_decay  # decay PER EPISODE (bukan per step)
    ...
    def train(self):
        """Q-learning update — TIDAK decay epsilon di sini."""
    ...
    def decay_epsilon(self):
        """Dipanggil SEKALI per episode dari training loop."""
